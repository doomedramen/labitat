...
test.describe("First-time Setup", () => {
  ...
  test("shows setup form with email, password, confirm password fields", async ({ page }) => {
  ...
  test("shows error for short password via form validation", async ({ page }) => {
    await page.goto("/setup");
  ...
  test("redirects away from /setup when admin already exists", async ({ page }) => {
