...
describe("adapter mock utilities - examples", () => {
  ...
  describe("getMocksForAdapter - dynamic mock retrieval", () => {
    it("gets success mocks for radarr", async () => {
      const mockResponses = getMocksForAdapter("radarr", "success", "https://radarr.test", {
        queued: 20,
        movies: 200,
      });
    ...
    it("gets error mocks for sonarr", async () => {
      const mockResponses = getMocksForAdapter("sonarr", "error", "https://sonarr.test", undefined);
