...
describe("fetchWithTimeout", () => {
  ...
  it("aborts when timeout exceeded", async () => {
    ...
    await expect(fetchWithTimeout("https://example.com", undefined, 50)).rejects.toThrow(
      "Request timed out",
    );
  });
  ...
  it("respects custom timeout", async () => {
    ...
    await expect(fetchWithTimeout("https://example.com", undefined, 100)).rejects.toThrow();
