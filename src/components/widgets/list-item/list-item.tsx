...
const STATUS_CONFIG: Record<string, StatusConfig> = {
  Downloading: {
    ...
    glowColor: "shadow-[0_0_8px_-2px_color-mix(in_srgb,var(--primary)_40%,transparent)]",
  },
  "Forced downloading": {
    icon: "download",
    label: "DL",
    className: "bg-primary/20 text-primary dark:bg-primary/30",
    glowColor: "shadow-[0_0_12px_-2px_color-mix(in_srgb,var(--primary)_50%,transparent)]",
  },
  Importing: {
    icon: "import",
    label: "IMP",
    className: "bg-success/15 text-success dark:bg-success/20",
    glowColor: "shadow-[0_0_8px_-2px_color-mix(in_srgb,var(--success)_40%,transparent)]",
  },
  Queued: {
    icon: "queued",
    label: "Q",
  ...
  Stalled: {
    ...
    glowColor: "shadow-[0_0_8px_-2px_color-mix(in_srgb,var(--warning)_30%,transparent)]",
  },
  Paused: {
    icon: "pause",
    label: "PA",
  ...
  "Fetching metadata": {
    ...
    glowColor: "shadow-[0_0_8px_-2px_color-mix(in_srgb,var(--info)_40%,transparent)]",
  },
  "Import pending": {
    icon: "import",
    label: "IP",
  ...
  "Failed pending": {
    ...
    glowColor: "shadow-[0_0_8px_-2px_color-mix(in_srgb,var(--destructive)_40%,transparent)]",
  },
  Failed: {
    icon: "error",
    label: "ERR",
    className: "bg-destructive/20 text-destructive dark:bg-destructive/25",
    glowColor: "shadow-[0_0_10px_-2px_color-mix(in_srgb,var(--destructive)_50%,transparent)]",
  },
  playing: {
    icon: "play",
    label: "PLAY",
